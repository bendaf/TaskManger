...
import hu.trio.taskActivity.TaskArrayAdapter.VH;
...
public class TaskArrayAdapter2 extends BaseAdapter {
	...
	public TaskArrayAdapter2(Context context, ArrayList<Task> tasks) {
		mTaskList = tasks;
